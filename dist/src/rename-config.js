// Diretórios
export const INPUT_DIR = "rename-images/images"; // Diretório com as imagens a serem renomeadas
export const OUTPUT_DIR = "rename-images/organized"; // Diretório de saída com as imagens organizadas
...
export const RECURSIVE_SEARCH = true; // Buscar em subdiretórios
export const COPY_FILES = true; // true para copiar, false para mover
export const DRY_RUN = false; // true para simular sem fazer alterações
export const LOG_LEVEL = "info"; // "debug", "info", "warn", "error"
// Contadores para sequência de arquivos adicionais
export const COUNTERS = {
    additional: {}, // Contador por código
    initialized: false,
};
...
//# sourceMappingURL=rename-config.js.map